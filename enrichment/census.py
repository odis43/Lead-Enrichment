...
from constants import STATE_FIPS, CENSUS_BASE_URL, CENSUS_VARIABLES, CENSUS_TOTAL_OCCUPIED_UNITS, CENSUS_RENTER_OCCUPIED_UNITS, CENSUS_TOTAL_HOUSING_UNITS, CENSUS_MEDIAN_HOUSEHOLD_INCOME
